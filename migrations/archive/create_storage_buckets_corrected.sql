-- =====================================================
-- SUPABASE STORAGE BUCKETS SETUP (CORRECTED VERSION)
-- =====================================================
...
ON storage.objects FOR INSERT WITH CHECK
USING (bucket_id = 'tournament-screenshots' AND auth.uid() IS NOT NULL);
...
ON storage.objects FOR INSERT WITH CHECK
USING (bucket_id = 'venue-layouts' AND auth.uid() IS NOT NULL);
...
ON storage.objects FOR INSERT WITH CHECK
USING (bucket_id = 'notification-attachments' AND auth.uid() IS NOT NULL);
