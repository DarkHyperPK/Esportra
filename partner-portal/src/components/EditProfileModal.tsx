...
import { X, Save, Loader2, Link as LinkIcon, Image as ImageIcon, FileText } from 'lucide-react';
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[90vh] overflow-y-auto custom-scrollbar bg-[#0a0a0c] border border-zinc-800 rounded-2xl shadow-2xl z-50"
                    >
                        {/* Header */}
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4 pt-4 border-t border-white/5">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label className="text-xs font-mono text-zinc-500 uppercase tracking-widest mb-2 block">Logo URL</label>
                                            <input
                                                type="url"
                                                value={formData.logo_url}
                                                onChange={(e) => setFormData({ ...formData, logo_url: e.target.value })}
                                                className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-3 text-white focus:border-rose-500 focus:ring-1 focus:ring-rose-500 transition-colors outline-none text-sm font-mono"
                                            />
                                        </div>
                                        <div>
                                            <label className="text-xs font-mono text-zinc-500 uppercase tracking-widest mb-2 block">Banner URL</label>
                                            <input
                                                type="url"
