-- =====================================================
-- SIMPLE TOURNAMENT REGISTRATION FIX
-- =====================================================
-- This script safely fixes the tournament registration system
...
-- =====================================================
-- 2. SAFELY RECREATE TOURNAMENT_PARTICIPANTS TABLE
-- =====================================================

-- Drop existing table if it exists (this will also drop any existing data)
...
BEGIN
    ...
    RAISE NOTICE 'Table created: tournament_participants with complete registration support';
