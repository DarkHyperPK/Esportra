-- Fix: Remove best_of = 1 hardcoding from reset_tournament_bracket
-- This update preserves the existing best_of value instead of resetting to 1
...
COMMENT ON FUNCTION public.reset_tournament_bracket IS 'Completely resets a tournament bracket (results, vetos, matches) in a single transaction. Note: best_of is NOT reset.';
