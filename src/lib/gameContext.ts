...
const GAME_CONTEXT: Record<string, GameContext> = {
  'Valorant': {
    ...
    suggestedTemplateIds: ['weekly-circuit', 'qualifier-ladder', 'single-major'],
    hasMapVeto: true,
    hasPickBan: false,
  ...
  'League of Legends': {
    ...
    defaultTeamSize: 5,
    defaultFormat: 'double_elimination',
    suggestedTemplateIds: ['weekly-circuit', 'qualifier-ladder', 'monthly-series'],
    hasMapVeto: false,
    hasPickBan: true,
    scoringType: 'match_wins',
    isTeamGame: true,
  ...
  'Fortnite': {
    ...
    suggestedTemplateIds: ['br-league'],
    hasMapVeto: false,
    hasPickBan: false,
  ...
  'Rocket League': {
    ...
    defaultTeamSize: 3,
    defaultFormat: 'swiss',
    suggestedTemplateIds: ['weekly-circuit', 'monthly-series', 'single-major'],
    hasMapVeto: false,
    hasPickBan: false,
    scoringType: 'match_wins',
    isTeamGame: true,
  ...
  'Tekken 8': {
    ...
    defaultTeamSize: 1,
    defaultFormat: 'double_elimination',
    suggestedTemplateIds: ['weekly-showdown', 'single-major'],
    hasMapVeto: false,
    hasPickBan: false,
    scoringType: 'match_wins',
    isTeamGame: false,
