              ...
              <nav className="space-y-2">
                <TabsList className="flex flex-col w-full bg-transparent">
                  <TabsTrigger 
                    ...
                    className={"justify-start " + (activeTab === "venues" ? "bg-gaming-purple/20" : "")}
                  >
                  ...
                  <TabsTrigger 
                    ...
                    className={"justify-start " + (activeTab === "bookings" ? "bg-gaming-purple/20" : "")}
                  >
                  ...
                  <TabsTrigger 
                    ...
                    className={"justify-start " + (activeTab === "availability" ? "bg-gaming-purple/20" : "")}
                  >
                  ...
                  <TabsTrigger 
                    ...
                    className={"justify-start " + (activeTab === "payments" ? "bg-gaming-purple/20" : "")}
                  >
