...
const STEPS = [
    ...
    { id: 5, title: 'License Terms', icon: ShieldCheck },
...
const OrganizationWizard: React.FC = () => {
    ...
    const nextStep = () => {
        ...
        if (currentStep === 5 && !licenseAccepted) {
            toast({ title: 'Acceptance Required', description: 'You must accept the Organizer License Terms to continue.', variant: 'destructive' });
            return;
        }
            ...
            <div className="relative z-10 container mx-auto px-4 py-12 max-w-4xl">
                ...
                <div className="flex justify-between mt-8">
                    ...
                    {currentStep < 6 ? (
                        <Button
                            onClick={nextStep}
                            disabled={currentStep === 5 && !licenseAccepted}
                            className="bg-gradient-to-r from-esports-purple to-esports-accent hover:from-esports-purple/90 hover:to-esports-accent/90 gap-2 px-8 disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                            Next
                        ...
                        <Button
                            ...
                            disabled={saving || !name.trim() || !slug.trim() || !licenseAccepted}
...
const StepLicenseTerms: React.FC<{
    accepted: boolean;
    ...
    <div className="space-y-6">
        <div className="text-center">
            ...
            <h2 className="text-2xl font-bold font-heading mb-2">Organizer License Terms</h2>
            <p className="text-gray-400 text-sm max-w-lg mx-auto">
                Before creating your organization you must read and accept the Esportra Organizer License Terms &amp; Sponsorship Policy.
            </p>
        </div>
            ...
            >
                <div
                    className={`mt-0.5 w-5 h-5 flex-shrink-0 rounded border-2 flex items-center justify-center transition-colors ${
                        accepted ? 'bg-rose-500 border-rose-500' : 'border-white/30'
                    }`}
                >
