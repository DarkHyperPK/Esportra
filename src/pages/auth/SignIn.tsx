...
import { AlertCircle, Eye, EyeOff, Loader2, CheckCircle, ArrowRight } from 'lucide-react';
...
const SignIn = () => {
  ...
  if (isAlreadySignedIn) {
    return (
      <AuthLayout title="Already Signed In" subtitle="Redirecting you to the dashboard..." variant="signin">
        <motion.div
  ...
  return (
    <AuthLayout title="Sign In" subtitle="Enter your credentials to continue" variant="signin">
      {error && (
        <motion.div
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    className="h-12 bg-zinc-900/50 border-zinc-800 text-white placeholder:text-zinc-500 focus:border-rose-500 focus:ring-rose-500/20"
                    {...field}
                  />
                </FormControl>
                ...
                <FormControl>
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 bg-zinc-900/50 border-zinc-800 text-white placeholder:text-zinc-500 focus:border-rose-500 focus:ring-rose-500/20 pr-12"
                      {...field}
                    />
                    <button
                      type="button"
