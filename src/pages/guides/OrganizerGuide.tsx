...
const guideSections: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: 'Step 2 — Tournament Flow',
        content: 'Design the circuit of tournaments. Use one of two templates (Regional Circuit or Event Series) to scaffold a typical layout, or use the quick-add buttons (Qualifier, Event, Finals) to build manually. Each tournament you add appears in the canvas grouped by type.',
        navigation: 'New Season Wizard → Step 2: Tournament Flow',
      ...
      },
      {
        ...
        content: 'Each tournament has a role that controls how it\'s categorised:\n\n• Qualifier — Entry-level competition. Teams compete here to earn a spot in later tournaments.\n• Event — A major competition stop within the season.\n• Finals — The closing championship where qualifying paths converge.\n• Custom — Fully flexible. Use for showmatches, boot camps, or anything non-standard.\n\nThe role is set when you add a tournament and is for display purposes — it doesn\'t enforce any automatic logic.',
      },
      {
        title: 'Tournament setup (inline config)',
        content: 'Each tournament is configured directly in the Inspector — format, registration type, team size, max teams, best-of, entry fee, and prize pool. A tournament is considered "ready" only when all required fields are filled in. The builder validates this before allowing you to proceed.',
        navigation: 'Inspector panel → Tournament setup',
      },
      {
        title: 'Advancement rules',
        content: 'Advancement rules define how teams move from one tournament to the next. Select a tournament in the canvas and open the "Advancement out" section in the Inspector. Add a target tournament, choose a rule type (top N teams, top %, points threshold, or manual), set the rule value, and pick a seed mode.\n\nThis is what creates the competitive circuit — without advancement rules, tournaments are independent.',
        navigation: 'Inspector panel → Advancement out',
        tip: 'A tournament can advance top teams to multiple destinations — useful when multiple events run in parallel and top qualifiers distribute across them.',
      },
      {
