              ...
              {selectedDispute && (() => {
                ...
                return (
                  <>
                    ...
                    <div className="flex-[3] min-h-0 overflow-y-auto px-6 py-5 space-y-5 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/10">
                      {matchView.hasMatch && (
                    ...
                    {/* Chat section */}
                    <div className="flex-[2] min-h-0 border-t border-white/[0.06] flex flex-col overflow-hidden">
