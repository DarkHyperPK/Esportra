...
const destinationHost = (value: string | null) => { if (!value) return 'Non-clickable'; try { return new URL(value).host; } catch { return 'Invalid destination'; } };
