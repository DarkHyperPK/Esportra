    ...
    <div className="flex items-center gap-3">
     ...
     <div>
      ...
      <p className="text-xs text-zinc-500 mt-0.5">
       ...
       <span className="text-emerald-300 font-medium">All tiers</span>
      </p>
     </div>
    </div>
   </div>
        ...
        <div key={slotNumber} className="min-w-0">
         ...
         {placement ? (
          ...
          <button
           ...
           className="flex aspect-square w-full items-center justify-center gap-1.5 border border-dashed border-zinc-700 bg-zinc-950/50 text-xs text-zinc-500 transition-colors hover:border-rose-500/50 hover:text-rose-400"
          >
