...
export function SocialLinks({ socials }: SocialLinksProps): React.JSX.Element | null {
  ...
  if (socials.twitter) {
    entries.push({
      ...
      renderIcon: () => <Twitter size={20} color="rgba(255,255,255,0.5)" />,
    });
  }
  if (socials.twitch) {
    entries.push({
      ...
      renderIcon: () => <Twitch size={20} color="rgba(255,255,255,0.5)" />,
    });
  }
  if (socials.youtube) {
    entries.push({
      ...
      renderIcon: () => <Youtube size={20} color="rgba(255,255,255,0.5)" />,
    });
  }
  if (socials.instagram) {
    entries.push({
      ...
      renderIcon: () => <Instagram size={20} color="rgba(255,255,255,0.5)" />,
    });
  }
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 16 }}>
      {entries.map(({ platform, handle, href, renderIcon }) => {
        const content = (
          <>
            {renderIcon()}
            <span
