...
const DesktopNav = ({
  ...
  const menuItemClass =
    "w-full rounded-none px-4 py-2 text-[0.75rem] font-semibold text-white/70 transition-all focus:text-white hover:text-white hover:bg-white/10 focus:bg-white/10";
    ...
    <div className="hidden lg:flex items-center gap-5 font-heading font-medium">
      ...
      {user ? (
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            className="border-white/30 bg-black text-white/80 hover:bg-white hover:text-black rounded-none"
            asChild
          >
            <Link to="/auth/signin">Log In</Link>
          </Button>
          <Button
            className="bg-white text-black hover:bg-rose-500 hover:text-white font-mono font-bold uppercase tracking-wider rounded-none"
            asChild
          >
