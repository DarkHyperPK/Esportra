    ...
    return (
        ...
        >
            ...
            {activeFilter.type === 'all' && (
                ...
                >
                    {/* Edges logic would need graph edges, or we can infer from match connections if available */}
                    {/* For now, omitting edges in renderer if not passed explicitly, or we can pass edges as prop */}
                    {/* Assuming edges are not critical for export or can be added later */}
                </svg>
            )}
