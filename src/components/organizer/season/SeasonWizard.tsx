      ...
      <div className="bg-[#111111] border border-[#2a2a2a] p-8">
        ...
        <div className="mb-8">
          ...
          <div>
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center gap-2 h-20 border ${
                      selected
                        ...
                        : errors.game
                          ? 'border-[#ef4444]/50 bg-[#0a0a0a]'
                          : 'border-[#2a2a2a] bg-[#0a0a0a]'
                    } hover:border-[#404040] transition-none`}
                    title={game.name}
                  >
                    <img
                      src={game.logo}
            ...
            {errors.game && (
              <p className="text-[#ef4444] text-xs uppercase tracking-wider mt-2">{errors.game}</p>
            )}
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full h-12 px-4 bg-[#0a0a0a] text-white text-sm border border-[#2a2a2a] focus:border-white focus:outline-none rounded-none"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-[#a0a0a0] uppercase tracking-widest mb-2">
