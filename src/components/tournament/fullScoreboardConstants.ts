export const MAP_THEMES: Record<string, { color: string; bg: string; id: string }> = {
    ...
    'split': { color: 'text-rose-400', bg: 'bg-rose-500/10', id: 'd960549e-485c-e861-8d71-aa9d1aed12a2' },
    ...
    'sunset': { color: 'text-rose-400', bg: 'bg-rose-500/10', id: '92584fbe-486a-b1b2-9faa-39b0f486b498' },
    'juliett': { color: 'text-rose-400', bg: 'bg-rose-500/10', id: '92584fbe-486a-b1b2-9faa-39b0f486b498' },
