    ...
    return (
        <>
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                ...
                {/* Accent Blobs */}
                <div className="absolute top-[-20%] right-[-10%] w-[60vw] h-[60vw] bg-esports-primary/10 blur-[150px] rounded-full mix-blend-screen backdrop-blur-sm" />
                <div className="absolute bottom-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-blue-600/10 blur-[150px] rounded-full mix-blend-screen backdrop-blur-sm" />
            </div>
