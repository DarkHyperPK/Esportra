                                            ...
                                            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                                ...
                                                {showInviteRedemption && onRedeemInvite && (
                                                    <button type="button"
                                                        ...
                                                        className="h-14 md:h-16 px-8 md:px-12 border border-white/15 bg-rose-600/20 hover:bg-rose-600/40 text-white text-base md:text-lg font-bold font-mono tracking-wider rounded-none shadow-[0_0_30px_rgba(244,63,94,0.15)]"
                                                    >
