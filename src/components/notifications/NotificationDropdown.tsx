...
import { Bell, CheckCheck, Users, ShieldAlert, Info, ArrowRight, Shield, Check, X, Loader2, FileText, CheckCircle2, AlertTriangle, XCircle, Swords, Map, Trophy, Ticket, Calendar, UserMinus, Crown } from 'lucide-react';
...
export const NotificationDropdown = () => {
    ...
    const typeBg = (type: string) => {
        switch (type) {
            ...
            case 'team_member_removed': return 'bg-red-500/10 border-red-500/20';
            case 'team_roster_updated': return 'bg-blue-500/10 border-blue-500/20';
            case 'team_captain_changed': return 'bg-amber-500/10 border-amber-500/20';
            ...
            case 'tournament_invite': return 'bg-rose-500/10 border-rose-500/20';
            ...
            case 'br_lobby_schedule_changed': return 'bg-rose-500/10 border-rose-500/20';
