...
const AuditLogs: React.FC = () => {
 ...
 const getActionIcon = (actionType: string) => {
  switch (actionType.toLowerCase()) {
   case 'create': return <CheckCircle className="w-4 h-4 text-emerald-300" />;
   case 'update': return <Clock className="w-4 h-4 text-zinc-400" />;
   ...
   case 'approve': return <CheckCircle className="w-4 h-4 text-emerald-300" />;
 ...
 return (
  <div className="space-y-6">
   ...
   {/* Filters */}
   <div className="bg-[#0a0a0c] border border-zinc-800/50 p-4">
   ...
   {/* Logs Table */}
   <div className="bg-[#0a0a0c] border border-zinc-800/50 overflow-hidden">
     <Table>
      <TableHeader>
