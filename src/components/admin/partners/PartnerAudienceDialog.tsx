      ...
      <DialogContent className="max-h-[85vh] max-w-4xl overflow-y-auto border-zinc-800 bg-[#0a0a0c] text-white" data-lenis-prevent>
        ...
        {report.isLoading ? <State text="Loading audience report…" />
          ...
          : <div className="space-y-6">
              ...
              <p className="rounded-xl border border-white/5 p-4 text-xs text-zinc-500">Segment counts are exact, including small groups. Unknown is coverage only and is never redistributed.</p>
            </div>}
      </DialogContent>
    </Dialog>
  );
