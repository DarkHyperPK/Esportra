...
- platform: X, LinkedIn, TikTok, YouTube, newsletter, **website landing**, or multi-platform
- goal: awareness, conversion, recruiting, authority, launch support, or engagement

For **Esportra website copy** (hero, landing, About), use `esportra/references/brand-voice-profile.md` and `esportra/references/marketing-copy-locations.md` — adapt hooks for web layout, do not use social compression rules on long-form sections.
