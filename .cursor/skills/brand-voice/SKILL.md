...
When working in the Esportra repo, load the operational voice profile at `.cursor/skills/esportra/references/brand-voice-profile.md` before drafting site copy, CTAs, or marketing content. Site copy file map: `.cursor/skills/esportra/references/marketing-copy-locations.md`.
