-- =====================================================
-- SAFE DATABASE SETUP - STEP BY STEP
-- =====================================================
-- This script creates the database step by step to avoid column errors
...
BEGIN
    ...
    -- Teams indexes
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'teams' AND column_name = 'owner_id') THEN
        CREATE INDEX IF NOT EXISTS idx_teams_owner_id ON public.teams(owner_id);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'teams' AND column_name = 'game') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'team_invites' AND column_name = 'team_id') THEN
        CREATE INDEX IF NOT EXISTS idx_team_invites_team_id ON public.team_invites(team_id);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'team_invites' AND column_name = 'user_id') THEN
        CREATE INDEX IF NOT EXISTS idx_team_invites_user_id ON public.team_invites(user_id);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'team_invites' AND column_name = 'status') THEN
        CREATE INDEX IF NOT EXISTS idx_team_invites_status ON public.team_invites(status);
    END IF;

    -- Tournaments indexes
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'tournaments' AND column_name = 'owner_id') THEN
        CREATE INDEX IF NOT EXISTS idx_tournaments_owner_id ON public.tournaments(owner_id);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'tournaments' AND column_name = 'venue_id') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'tournaments' AND column_name = 'is_featured') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'tournament_participants' AND column_name = 'team_id') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'tournament_matches' AND column_name = 'tournament_id') THEN
        CREATE INDEX IF NOT EXISTS idx_tournament_matches_tournament_id ON public.tournament_matches(tournament_id);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'tournament_matches' AND column_name = 'round_number') THEN
        CREATE INDEX IF NOT EXISTS idx_tournament_matches_round_number ON public.tournament_matches(round_number);
    END IF;

    -- Venues indexes
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'venues' AND column_name = 'owner_id') THEN
        CREATE INDEX IF NOT EXISTS idx_venues_owner_id ON public.venues(owner_id);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'venues' AND column_name = 'city') THEN
        CREATE INDEX IF NOT EXISTS idx_venues_city ON public.venues(city);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'venues' AND column_name = 'is_verified') THEN
        CREATE INDEX IF NOT EXISTS idx_venues_is_verified ON public.venues(is_verified);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'venues' AND column_name = 'is_active') THEN
        CREATE INDEX IF NOT EXISTS idx_venues_is_active ON public.venues(is_active);
    END IF;

    -- Venue bookings indexes
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'venue_bookings' AND column_name = 'venue_id') THEN
        CREATE INDEX IF NOT EXISTS idx_venue_bookings_venue_id ON public.venue_bookings(venue_id);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'venue_bookings' AND column_name = 'user_id') THEN
        CREATE INDEX IF NOT EXISTS idx_venue_bookings_user_id ON public.venue_bookings(user_id);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'venue_bookings' AND column_name = 'tournament_id') THEN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'verification_requests' AND column_name = 'status') THEN
        CREATE INDEX IF NOT EXISTS idx_verification_requests_status ON public.verification_requests(status);
    END IF;
    
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'verification_requests' AND column_name = 'requested_role') THEN
...
-- 17. SUCCESS MESSAGE
-- =====================================================
SELECT '🎉 Safe database setup completed successfully!' as message;
SELECT '✅ All tables created with proper column names' as status;
SELECT '✅ Indexes created safely' as result;
SELECT '✅ Admin system ready to use' as next_step;
